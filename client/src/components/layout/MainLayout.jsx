...
const MainLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-bg-primary flex relative">
      ...
      <main className="flex-1 transition-all duration-300 ml-20 md:ml-64 p-4 lg:p-8 relative z-10">
        {/* Header */}
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative group">
               <button className="w-12 h-12 bg-white dark:bg-[#1C1C1E] rounded-apple-lg border border-border flex items-center justify-center text-text-muted hover:text-brand-primary hover:border-brand-primary transition-all shadow-shadow-sm">
                  <Bell size={22} />
                  {stockBajo.length > 0 && (
            ...
            <div className="flex items-center gap-4 bg-white dark:bg-[#1C1C1E] p-2 px-4 rounded-apple-lg shadow-shadow-sm border border-border">
              ...
              <div className="w-10 h-10 rounded-apple-md bg-brand-soft flex items-center justify-center text-brand-primary font-black border border-brand-accent/20">
